Here,In the attached folder there are five(5) source files naming:
1.ArrL.java
2.Linlist.java
3.Test.java
4.TNL.java
...
5.LLOnline.java:
This problem was introduced in your online which I failed to complete in the due time.This file also creates a linked list type data structure based on two array lists.The implementation of this ADT is also demonstrated in the Test.java file.The functions which are implemented under this data structure are:
a)clear()
b)insert(item)
c)append(item)
d)remove()
